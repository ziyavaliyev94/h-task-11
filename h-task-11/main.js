...
// const randomNumberGenerater = () => Math.floor(Math.random() * users.length)
...
//     try {
//         let findKey = localStorage.getItem(key)
//         if (findKey) {
...
// const randomNumberGenerater = (length) => Math.floor(Math.random() * length);

// let operator = ["055", "077", "070", "051", "099", "050", "010"]

// const updateUSer = () => {
//     try {
//         users.forEach((item) => {
//             let newOperator = operator[randomNumberGenerater(operator.length)];
//             let randomNumber = `${randomNumberGenerater(10)}${randomNumberGenerater(10)}${randomNumberGenerater(10)}-${randomNumberGenerater(10)}${randomNumberGenerater(10)}-${randomNumberGenerater(10)}${randomNumberGenerater(10)}`
//             item.phone = `${newOperator}-${randomNumber}`
//             console.log(item);
...
//         console.log(`${user.firstName} ${age} yashindadir`);
//     });
// }
